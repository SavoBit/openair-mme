...
int s10_mme_forward_relocation_request(
   ...
   */
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_RELOCATION_REQ,
  ...
  ulp_req.u_api_info.initialReqInfo.hUlpTunnel =
      0; /** Will create a local tunnel with type INIT_REQ. */
  ...
  rc = nwGtpv2cMsgAddIeFteid(
      (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO, S10_MME_GTP_C,
      req_p->s10_source_mme_teid.teid,
      req_p->s10_source_mme_teid.ipv4 ? &req_p->s10_source_mme_teid.ipv4_address
                                      : 0,
      req_p->s10_source_mme_teid.ipv6 ? &req_p->s10_source_mme_teid.ipv6_address
                                      : NULL);
  ...
  /*  rc = nwGtpv2cMsgAddIeFteid ((ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ONE,
     ...
     ntohl(req_p->pgw_address_for_cp.ipv4_address) : 0,
                                req_p->pgw_address_for_cp.ipv6 ?
     req_p->pgw_address_for_cp.ipv6_address : NULL);
  */

  /**
   * Target Identification.
   */
  gtpv2c_target_identification_ie_set(&(ulp_req.hMsg),
                                      &req_p->target_identification);

  /*
   * Source S10 SAEGW F-TEID for Control Plane
   */
  rc = nwGtpv2cMsgAddIeFteid(
      (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ONE, S11_SGW_GTP_C,
   ...
   */
  rc = nwGtpv2cMsgAddIeFContainer(
      (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO,
  ...
  //          0x40, 0x80, 0xc0, 0x0f, 0x10, 0x3f, 0xc5, 0x9a, 0xd4, 0x80, 0x01,
  //          0x06, 0x0e, 0x4d, 0x2a, 0x64, 0xea, 0x04, 0x48, 0xff, 0x8b, 0xfc,
  //          0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8,
  //          0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xfc, 0x8f,
  //          0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xff, 0xfe, 0x7f, 0xf5, 0xf4, 0x40,
  //          0x40, 0x70, 0xca, 0x74, 0xa9, 0x3b, 0xbe, 0x06, 0x9c, 0x08, 0x00,
  //          0x00, 0x06, 0xc0, 0x15, 0xe0, 0x00, 0x10, 0x06, 0x0e, 0x5a, 0xf0,
  //          0x00, 0x14, 0x80, 0x43, 0xcb, 0x80, 0x00, 0x02, 0x32, 0x11, 0x41,
  //          0xbd, 0x80, 0x9e, 0x18, 0xe0, 0x18, 0x3c, 0x1c, 0x09, 0xe1, 0x8e,
  //          0x01, 0x83, 0xc0, 0x1f, 0x51, 0x34, 0x81, 0x68, 0x3a, 0x0c, 0x0e,
  //          0x1a, 0x67, 0xcc, 0x01, 0xe9, 0x2c, 0x7f, 0xe8, 0x00, 0x8c, 0x30,
  //          0x64, 0x81, 0x4c, 0x02, 0x05, 0x44, 0x0d, 0x9c, 0x00, 0x05, 0x45,
  //          0x0a, 0x50, 0xd0, 0x00, 0x29, 0x00, 0x40, 0x70, 0x2a, 0x58, 0x00,
  //          0x28, 0x40, 0x24, 0x13, 0x02, 0x59, 0x00, 0x0c, 0xd0, 0x19, 0x00,
  //          0x6a, 0x30, 0x40, 0x08, 0x80, 0x17, 0xa5, 0x14, 0x09, 0x09, 0x2a,
  //          0xb7, 0x8d, 0x10, 0x00, 0x1a, 0x05, 0xa1, 0x40, 0x80, 0x00, 0x01,
  //          0x00, 0x1c, 0x2b, 0xec, 0x8a, 0xa2, 0x46, 0x00, 0xd4, 0x9b, 0x28,
  //          0x3a, 0x18, 0x38, 0x40, 0x80, 0x08, 0x14, 0x00, 0x00, 0x00, 0x4e,
  //          0x40, 0x01, 0x05, 0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00, 0x14,
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80, 0x00, 0x18,
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00, 0x10, 0x80, 0x00, 0x0e,
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80, 0x00, 0x1c,
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00, 0x10, 0x80, 0x00, 0x77,
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80, 0x00, 0x4d
  //
  //          ,0x40, 0x80, 0xc0, 0x0f, 0x10, 0x3f, 0xc5, 0x9a, 0xd4, 0x80, 0x01,
  //          0x06, 0x0e, 0x4d, 0x2a, 0x64, 0xea, 0x04, 0x48, 0xff, 0x8b, 0xfc,
  //          0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8,
  ...
  //          0x00, 0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80, 0x00, 0x4d
  //
  //                   ,0x40, 0x80, 0xc0, 0x0f, 0x10, 0x3f, 0xc5, 0x9a, 0xd4,
  //                   0x80, 0x01, 0x06, 0x0e, 0x4d, 0x2a, 0x64,
  //                    0xea, 0x04, 0x48, 0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf,
  //                    0xc8, 0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8, 0xff,
  //                    0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xfc,
  //                    0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b, 0xff, 0xfe, 0x7f,
  //                    0xf5, 0xf4, 0x40, 0x40, 0x70, 0xca, 0x74, 0xa9, 0x3b,
  //                    0xbe, 0x06, 0x9c, 0x08, 0x00, 0x00, 0x06, 0xc0, 0x15,
  //                    0xe0, 0x00, 0x10, 0x06, 0x0e, 0x5a, 0xf0, 0x00, 0x14,
  //                    0x80, 0x43, 0xcb, 0x80, 0x00, 0x02, 0x32, 0x11, 0x41,
  //                    0xbd, 0x80, 0x9e, 0x18, 0xe0, 0x18, 0x3c, 0x1c, 0x09,
  //                    0xe1, 0x8e, 0x01, 0x83, 0xc0, 0x1f, 0x51, 0x34, 0x81,
  //                    0x68, 0x3a, 0x0c, 0x0e, 0x1a, 0x67, 0xcc, 0x01, 0xe9,
  //                    0x2c, 0x7f, 0xe8, 0x00, 0x8c, 0x30, 0x64, 0x81, 0x4c,
  //                    0x02, 0x05, 0x44, 0x0d, 0x9c, 0x00, 0x05, 0x45, 0x0a,
  //                    0x50, 0xd0, 0x00, 0x29, 0x00, 0x40, 0x70, 0x2a, 0x58,
  //                    0x00, 0x28, 0x40, 0x24, 0x13, 0x02, 0x59, 0x00, 0x0c,
  //                    0xd0, 0x19, 0x00, 0x6a, 0x30, 0x40, 0x08, 0x80, 0x17,
  //
  //
  //                    0xa5, 0x14, 0x09, 0x09, 0x2a, 0xb7, 0x8d, 0x10, 0x00,
  //                    0x1a, 0x05, 0xa1, 0x40, 0x80, 0x00, 0x01, 0x00, 0x1c,
  //                    0x2b, 0xec, 0x8a, 0xa2, 0x46, 0x00, 0xd4, 0x9b, 0x28,
  //                    0x3a, 0x18, 0x38, 0x40, 0x80, 0x08, 0x14, 0x00, 0x00,
  //                    0x00, 0x4e, 0x40, 0x01, 0x05, 0x00, 0x00, 0xf9, 0x90,
  //                    0x00, 0x0d, 0x00, 0x14, 0x00, 0x00, 0xf9, 0x90, 0x00,
  //                    0x0c, 0xd0, 0x10, 0x80, 0x00, 0x18, 0x00, 0x00, 0xf9,
  //                    0x90, 0x00, 0x0d, 0x00, 0x10, 0x80, 0x00, 0x0e, 0x00,
  //                    0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80,
  //
  //                    0x00, 0x1c, 0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00,
  //                    0x10, 0x80, 0x00 , 0x77, 0x00, 0x00, 0xf9, 0x90, 0x00,
  //                    0x0c, 0xd0, 0x10, 0x80, 0x00, 0x4d
  //
  ////                    0x00, 0x1c, 0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00,
  /// 0x10, // 0x80, //    0x00 , 0x77, 0x00, 0x00, 0xf9,
  //////                    0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80, 0x00, 0x4d
  ////
  //                    ,0x40, 0x80, 0xc0, 0x0f, 0x10, 0x3f, 0xc5, 0x9a, 0xd4,
  //                    0x80, 0x01, 0x06, 0x0e, 0x4d, 0x2a, 0x64,
  //                                     0xea, 0x04, 0x48, 0xff, 0x8b, 0xfc,
  //                                     0x8f, 0xf8, 0xbf, 0xc8, 0xff, 0x8b,
  //                                     0xfc, 0x8f, 0xf8, 0xbf, 0xc8, 0xff,
  //                                     0x8b, 0xfc, 0x8f, 0xf8, 0xbf, 0xc8,
  //                                     0xff, 0x8b, 0xfc, 0x8f, 0xf8, 0xbf,
  //                                     0xc8, 0xff, 0x8b, 0xff, 0xfe, 0x7f,
  //                                     0xf5, 0xf4, 0x40, 0x40, 0x70, 0xca,
  //                                     0x74, 0xa9, 0x3b, 0xbe, 0x06, 0x9c,
  //                                     0x08, 0x00, 0x00, 0x06, 0xc0, 0x15,
  //                                     0xe0, 0x00, 0x10, 0x06, 0x0e, 0x5a,
  //                                     0xf0, 0x00, 0x14, 0x80, 0x43, 0xcb,
  //                                     0x80, 0x00, 0x02, 0x32, 0x11, 0x41,
  //                                     0xbd, 0x80, 0x9e, 0x18, 0xe0, 0x18,
  //                                     0x3c, 0x1c, 0x09, 0xe1, 0x8e, 0x01,
  //                                     0x83, 0xc0, 0x1f, 0x51, 0x34, 0x81,
  //                                     0x68, 0x3a, 0x0c, 0x0e, 0x1a, 0x67,
  //                                     0xcc, 0x01, 0xe9, 0x2c, 0x7f, 0xe8,
  //                                     0x00, 0x8c, 0x30, 0x64, 0x81, 0x4c,
  //                                     0x02, 0x05, 0x44, 0x0d, 0x9c, 0x00,
  //                                     0x05, 0x45, 0x0a, 0x50, 0xd0, 0x00,
  //                                     0x29, 0x00, 0x40, 0x70, 0x2a, 0x58,
  //                                     0x00, 0x28, 0x40, 0x24, 0x13, 0x02,
  //                                     0x59, 0x00, 0x0c, 0xd0, 0x19, 0x00,
  //                                     0x6a, 0x30, 0x40, 0x08, 0x80, 0x17,
  //                                     0xa5, 0x14, 0x09, 0x09, 0x2a, 0xb7,
  //                                     0x8d, 0x10, 0x00, 0x1a, 0x05, 0xa1,
  //                                     0x40, 0x80, 0x00, 0x01, 0x00, 0x1c,
  //                                     0x2b, 0xec, 0x8a, 0xa2, 0x46, 0x00,
  //                                     0xd4, 0x9b, 0x28, 0x3a, 0x18, 0x38,
  //                                     0x40, 0x80, 0x08, 0x14, 0x00, 0x00,
  //                                     0x00, 0x4e, 0x40, 0x01, 0x05, 0x00,
  //                                     0x00, 0xf9, 0x90, 0x00, 0x0d, 0x00,
  //                                     0x14, 0x00, 0x00, 0xf9, 0x90, 0x00,
  //                                     0x0c, 0xd0, 0x10, 0x80, 0x00, 0x18,
  //                                     0x00, 0x00, 0xf9, 0x90, 0x00, 0x0d,
  //                                     0x00, 0x10, 0x80, 0x00, 0x0e, 0x00,
  //                                     0x00, 0xf9, 0x90, 0x00, 0x0c, 0xd0,
  //                                     0x10, 0x80, 0x00, 0x1c, 0x00, 0x00,
  //                                     0xf9, 0x90, 0x00, 0x0d, 0x00, 0x10,
  //                                     0x80, 0x00, 0x77, 0x00, 0x00, 0xf9,
  //                                     0x90, 0x00, 0x0c, 0xd0, 0x10, 0x80,
  //                                     0x00, 0x4d
  //
  //   };
  //   bstring new_long_container = blk2bstr(container_map, ((264 * 4) ));
  //   rc = nwGtpv2cMsgAddIeFContainer((ulp_req.hMsg),
  ...
  DevAssert(MSG_FORWARD_RELOCATION_REQUEST_MAX_PDN_CONNECTIONS >=
            req_p->pdn_connections->num_pdn_connections);

  for (int num_pdn = 0; num_pdn < req_p->pdn_connections->num_pdn_connections;
       num_pdn++) {
    pdn_connection_t *pdn_connection =
        &req_p->pdn_connections->pdn_connection[num_pdn];
  ...
  DevAssert(NW_OK == rc);
  MSC_LOG_TX_MESSAGE(MSC_S10_MME, MSC_S10_MME, NULL, 0,
                     "0 FORWARD_RELOCATION_REQUEST local S10 teid " TEID_FMT
                     " num pdn connections %u",
                     req_p->s10_source_mme_teid.teid,
                     req_p->pdn_connections.num_pdn_connections);

  OAILOG_INFO(LOG_S10,
              "INSERTING INTO S10 HASHTABLE (2) teid " TEID_FMT
              " and tunnel object %p. \n",
              req_p->s10_source_mme_teid.teid,
              ulp_req.u_api_info.initialReqInfo.hTunnel);

  hashtable_rc_t hash_rc =
      hashtable_ts_insert(s10_mme_teid_2_gtv2c_teid_handle,
...
int s10_mme_handle_forward_relocation_request(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  /** Allocating the Signal once at the sender (MME_APP --> S10) and once at the
   * receiver (S10-->MME_APP). */
  ...
  memcpy((void *)&req_p->peer_ip, pUlpApi->u_api_info.initialReqIndInfo.peerIp,
         pUlpApi->u_api_info.initialReqIndInfo.peerIp->sa_family == AF_INET
   ...
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_FORWARD_RELOCATION_REQ,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_IMSI, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, gtpv2c_imsi_ie_get, &req_p->imsi);
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_PDN_CONNECTION, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_pdn_connection_ie_get,
      req_p->pdn_connections);
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_MM_EPS_CONTEXT, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_MANDATORY, s10_mm_ue_context_ie_get,
      req_p->ue_eps_mm_context);
  DevAssert(NW_OK == rc);
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(pMsgParser, NW_GTPV2C_IE_F_CONTAINER,
                              NW_GTPV2C_IE_INSTANCE_ZERO,
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_TARGET_IDENTIFICATION,
...
int s10_mme_forward_relocation_response(
  ...
  if (forward_relocation_response_p->cause.cause_value == REQUEST_ACCEPTED) {
    memset(&ulp_req, 0, sizeof(nw_gtpv2c_ulp_api_t));
    ulp_req.apiType =
        NW_GTPV2C_ULP_CREATE_LOCAL_TUNNEL; /**< Create a Tunnel Endpoint for the
                                              S10. */
    ulp_req.u_api_info.createLocalTunnelInfo.teidLocal =
        forward_relocation_response_p->s10_target_mme_teid.teid;
    ulp_req.u_api_info.createLocalTunnelInfo.peerIp =
        &forward_relocation_response_p->mme_peer_ip;
    ...
    if (NW_OK != rc) {
      OAILOG_ERROR(LOG_S10,
                   "Error, we could not setup local tunnel while sending "
                   "FW_RELOC_RESPONSE!. \n");
      return RETURNerror;
    }

    OAILOG_INFO(LOG_S10,
                "Successfully created tunnel while FW_RELOCA_RESP!. \n");
    OAILOG_INFO(LOG_S10,
                "INSERTING INTO S10 HASHTABLE (3) teid " TEID_FMT
                " and tunnel object %p. \n",
                ulp_req.u_api_info.createLocalTunnelInfo.teidLocal,
                ulp_req.u_api_info.createLocalTunnelInfo.hTunnel);

    hashtable_rc_t hash_rc = hashtable_ts_insert(
        s10_mme_teid_2_gtv2c_teid_handle,
    ...
    hash_rc = hashtable_ts_get(
        s10_mme_teid_2_gtv2c_teid_handle,
        (hash_key_t)ulp_req.u_api_info.createLocalTunnelInfo.teidLocal,
        (void **)(uintptr_t)&ulp_req.u_api_info.createLocalTunnelInfo.hTunnel);
    DevAssert(hash_rc == HASH_TABLE_OK);
  } else {
    OAILOG_WARNING(LOG_S10,
                   "The cause is not REQUEST_ACCEPTED but %d for "
  ...
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_RELOCATION_RSP, 0, 0,
                      &(ulp_req.hMsg));
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgAddIeCause((ulp_req.hMsg), 0,
                             forward_relocation_response_p->cause.cause_value,
                             0, 0, 0);
  DevAssert(NW_OK == rc);
  ...
  if (forward_relocation_response_p->cause.cause_value == REQUEST_ACCEPTED) {
    ...
    rc = nwGtpv2cMsgAddIeFteid(
        (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO, S10_MME_GTP_C,
        forward_relocation_response_p->s10_target_mme_teid
            .teid, /**< FTEID of the TARGET_MME. */
        forward_relocation_response_p->s10_target_mme_teid.ipv4
            ? &forward_relocation_response_p->s10_target_mme_teid.ipv4_address
            : 0,
        forward_relocation_response_p->s10_target_mme_teid.ipv6
            ? &forward_relocation_response_p->s10_target_mme_teid.ipv6_address
            : NULL);

    /** F-Cause to be added. */
    rc = nwGtpv2cMsgAddIeFCause(
        (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO,
        forward_relocation_response_p->f_cause.fcause_type,
    ...
    if (forward_relocation_response_p->eutran_container.container_value) {
      rc = nwGtpv2cMsgAddIeFContainer(
          (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO,
          (uint8_t *)forward_relocation_response_p->eutran_container
              .container_value->data,
          blength(
    ...
    for (int i = 0;
      ...
      gtpv2c_bearer_context_created_ie_set(
          &(ulp_req.hMsg),
          &forward_relocation_response_p->handovered_bearers.bearer_context[i]);
    }
  }
...
int s10_mme_handle_forward_relocation_response(
  ...
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_FORWARD_RELOCATION_RSP,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_F_CONTAINER, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_f_container_ie_get,
      &resp_p->eutran_container);
  DevAssert(NW_OK == rc);

  /*
   * Sender FTEID for CP IE
   * todo: TEID not saved in the tunnel endpoint. Why not saving in the S10
   * tunnel endpoints at all ? It will be saved in the mme_ue_context in the
   * MME_APP layer.
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_FTEID, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, gtpv2c_fteid_ie_get,
      &resp_p->s10_target_mme_teid);
  DevAssert(NW_OK == rc);
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 FORWARD_RELOCATION_RESPONSE local S10 teid " TEID_FMT " ",
        resp_p->teid);
    /*
     * TODO: handle this case
     */
  ...
  MSC_LOG_RX_MESSAGE(MSC_S10_MME, MSC_MMEAPP_MME, NULL, 0,
                     "0 FORWARD_RELOCATION_RESPONSE local S10 teid " TEID_FMT
                     " num bearer ctxt setup %u",
                     resp_p->teid, resp_p->list_of_bearers.num_bearer_context);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_forward_access_context_notification(
  ...
  if (HASH_TABLE_OK != hash_rc) {
    OAILOG_WARNING(LOG_S10,
                   "Could not get GTPv2-C hTunnel for local TEID %X on S10 MME "
                   "interface. \n",
                   ulp_req.u_api_info.initialReqInfo.teidLocal);
    return RETURNerror;
  }
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_ACCESS_CONTEXT_NTF, 0, 0,
                      &(ulp_req.hMsg));
  DevAssert(NW_OK == rc);
  /*
   * Set the remote TEID
  ...
  if (forward_access_context_notif_p->status_transfer_bearer_list) {
    char enbStatusPrefix_length[] = {
        0x00, (forward_access_context_notif_p->status_transfer_bearer_list
                   ->num_bearers -
               1)};
    bstring enbStatusPrefixBstr_final = blk2bstr(enbStatusPrefix_length, 2);
    for (int num_bearer = 0;
         num_bearer < forward_access_context_notif_p
                          ->status_transfer_bearer_list->num_bearers;
         num_bearer++) {
      char enbStatusPrefix[15] = {0x00, 0x59, 0x40, 0x0b};
      memcpy(&enbStatusPrefix[4],
             &forward_access_context_notif_p->status_transfer_bearer_list
                  ->bearerStatusTransferList[num_bearer],
             sizeof(forward_access_context_notif_p->status_transfer_bearer_list
                        ->bearerStatusTransferList[num_bearer]));
      bstring enbStatusPrefixBstr = blk2bstr(enbStatusPrefix, 15);
      //	  	  bconcat(enbStatusPrefixBstr,
      // forward_access_context_notif_p->status_transfer_bearer_list->bearerStatusTransferList_buffer[num_bearer]);
    ...
    rc = nwGtpv2cMsgAddIeFContainer((ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO,
                                    ...
                                    blength(enbStatusPrefixBstr_final) + 1, 3);
    DevAssert(NW_OK == rc);
    /** Destroy the container. */
...
int s10_mme_handle_forward_access_context_notification(
   ...
   * receiver (S10-->MME_APP). */
  message_p =
      itti_alloc_new_message(TASK_S10, S10_FORWARD_ACCESS_CONTEXT_NOTIFICATION);
  ...
  /*
   * Create a new message parser for the S10 FORWARD ACCESS CONTEXT
   * NOTIFICATION.
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_FORWARD_ACCESS_CONTEXT_NTF,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  /**
   * E-UTRAN container (F-Container) Information Element.
   * Instance Zero is E-UTRAN. Only E-UTRAN will be supported.
   */
  notif_p->status_transfer_bearer_list =
      calloc(1, sizeof(status_transfer_bearer_list_t));
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_F_CONTAINER, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_f_container_ie_get_2,
      notif_p->status_transfer_bearer_list);
  DevAssert(NW_OK == rc);
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 FORWARD_ACCESS_CONTEXT_NOTIFICATION local S10 teid " TEID_FMT " ",
        notif_p->teid);
    /*
     * TODO: handle this case
     */
  ...
  DevAssert(NW_OK == rc);
  MSC_LOG_RX_MESSAGE(
      MSC_S10_MME, MSC_MMEAPP_MME, NULL, 0,
      "0 FORWARD_ACCESS_CONTEXT_NOTIFICATION local S10 teid " TEID_FMT,
      notif_p->teid);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_forward_access_context_acknowledge(
  ...
  ulp_ack.u_api_info.triggeredRspInfo.teidLocal =
      forward_access_context_ack_p
          ->local_teid;  // todo: check which teid is the local one, which the
                         // remote..
  //  ulp_req.u_api_info.triggeredRspInfo.peerIp =
  //  forward_access_context_ack_p->peer_ip;
  ...
  //  ulp_ack.u_api_info.triggeredRspInfo.peerIp =
  //  forward_access_context_ack_p->peer_ip;

  hashtable_rc_t hash_rc = hashtable_ts_get(
      s10_mme_teid_2_gtv2c_teid_handle,
      (hash_key_t)ulp_ack.u_api_info.triggeredRspInfo.teidLocal,
  ...
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_ACCESS_CONTEXT_ACK, 0, 0,
                      &(ulp_ack.hMsg));
  DevAssert(NW_OK == rc);
  /*
   * Set the remote TEID
...
int s10_mme_handle_forward_access_context_acknowledge(
   ...
   * receiver (S10-->MME_APP). */
  message_p =
      itti_alloc_new_message(TASK_S10, S10_FORWARD_ACCESS_CONTEXT_ACKNOWLEDGE);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_CAUSE, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_MANDATORY, gtpv2c_cause_ie_get, &ack_p->cause);
  DevAssert(NW_OK == rc);
  /*
   * Run the parser
   */
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 FORWARD_ACCESS_CONTEXT_ACKNOWLEDGE local S10 teid " TEID_FMT " ",
        ack_p->teid);
    /*
     * TODO: handle this case
     */
  ...
  DevAssert(NW_OK == rc);
  MSC_LOG_RX_MESSAGE(
      MSC_S10_MME, MSC_S10_MME, NULL, 0,
      "0 FORWARD_ACCESS_CONTEXT_ACKNOWLEDGE local S10 teid " TEID_FMT,
      ack_p->teid);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_forward_relocation_complete_notification(
  ...
  memset(&ulp_req, 0, sizeof(nw_gtpv2c_ulp_api_t));
  ulp_req.apiType =
      NW_GTPV2C_ULP_API_INITIAL_REQ;  // todo: check if notification is an
                                      // initial request.

  /** Setting the destination TEID from MME_APP. */
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_RELOCATION_COMPLETE_NTF,
                      notif_p->teid, 0, &(ulp_req.hMsg));
  ulp_req.u_api_info.initialReqInfo.edns_peer_ip = &notif_p->mme_peer_ip;
  /** Setting the local teid twice, once here once later. */
  ulp_req.u_api_info.initialReqInfo.teidLocal =
      notif_p->local_teid; /**< Used to get the local tunnel... */
  ...
  if (HASH_TABLE_OK != hash_rc) {
    OAILOG_ERROR(LOG_S10,
                 "Could not get GTPv2-C hTunnel for local teid for handover "
                 "notification %X\n",
                 ulp_req.u_api_info.initialReqInfo.teidLocal);
    return RETURNerror;
  }
  ...
  MSC_LOG_TX_MESSAGE(
      MSC_S10_MME, MSC_S10_MME, NULL, 0,
      "0 FORWARD_RELOCATION_COMPLETE_NOTIFICATION local S10 teid " TEID_FMT,
      notif_p->local_teid);
...
int s10_mme_handle_forward_relocation_complete_notification(
  ...
  message_p = itti_alloc_new_message(
      TASK_S10, S10_FORWARD_RELOCATION_COMPLETE_NOTIFICATION);
...
int s10_mme_forward_relocation_complete_acknowledge(
  ...
  ulp_ack.u_api_info.triggeredRspInfo.teidLocal =
      forward_reloc_complete_ack_p->local_teid;
  ulp_ack.apiType = NW_GTPV2C_ULP_API_TRIGGERED_RSP; /**< Sending Side. */
  ulp_ack.u_api_info.triggeredRspInfo.hUlpTunnel = 0;
  ulp_ack.u_api_info.triggeredRspInfo.hTunnel = 0;
  ulp_ack.u_api_info.triggeredRspInfo.hTrxn = trxn;
  ...
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_FORWARD_RELOCATION_COMPLETE_ACK, 0,
                      0, &(ulp_ack.hMsg));
  DevAssert(NW_OK == rc);
  /*
   * Set the remote TEID.
...
int s10_mme_handle_forward_relocation_complete_acknowledge(
  ...
  DevAssert(stack_p);
  message_p = itti_alloc_new_message(
      TASK_S10, S10_FORWARD_RELOCATION_COMPLETE_ACKNOWLEDGE);
   ...
   * Create a new message parser
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_FORWARD_RELOCATION_COMPLETE_ACK,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  /*
   * Cause IE
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 FORWARD_RELOCATION_COMPLETE_ACKNOWLEDGE local S10 teid " TEID_FMT
        " ",
        ack_p->teid);
    /*
     * TODO: handle this case
  ...
  MSC_LOG_RX_MESSAGE(
      MSC_S10_MME, MSC_S10_MME, NULL, 0,
      "0 FORWARD_RELOCATION_COMPLETE_ACKOWLEDGE local S10 teid " TEID_FMT,
      ack_p->teid);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_context_request(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  memset(&ulp_req, 0, sizeof(nw_gtpv2c_ulp_api_t));
  ulp_req.apiType = NW_GTPV2C_ULP_API_INITIAL_REQ;
  /**< Initial Request will create a local S10 tunnel in the ULP handler, if
   * none existing. Below the ULP tunnel will be inserted into the hash map with
   * local S10 teid as key.
   */

  /*
   * Prepare a new Context Request msg
   */
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_CONTEXT_REQ, req_p->teid, 0,
                      &(ulp_req.hMsg));
  ulp_req.u_api_info.initialReqInfo.edns_peer_ip = &req_p->mme_peer_ip;
  ...
  rc = nwGtpv2cMsgAddIeFteid(
      ...
      req_p->s10_target_mme_teid.ipv4 ? &req_p->s10_target_mme_teid.ipv4_address
                                      : 0,
      req_p->s10_target_mme_teid.ipv6 ? &req_p->s10_target_mme_teid.ipv6_address
                                      : NULL);
  /**
   * Serving Network.
   */
   ...
   */
  rc = nwGtpv2cMsgAddIeCompleteRequestMessage(
      (ulp_req.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO,
  ...
  rc = nwGtpv2cProcessUlpReq(
      *stack_p, &ulp_req); /**< Creates an ULP tunnel if none existing. */
  DevAssert(NW_OK == rc);
  MSC_LOG_TX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     " CONTEXT_REQUEST local S10 teid " TEID_FMT,
                     req_p->s10_target_mme_teid.teid);

  /**
   * Just an int is stored. When the value is removed from the tunnel pool,
   * nothing will be deallocated. Free method does nothing!
   */
  OAILOG_INFO(LOG_S10,
              "INSERTING INTO S10 HASHTABLE (4) teid " TEID_FMT
              " and tunnel object %p. \n",
              req_p->s10_target_mme_teid.teid,
              ulp_req.u_api_info.initialReqInfo.hTunnel);
  hashtable_rc_t hash_rc =
...
int s10_mme_handle_context_request(nw_gtpv2c_stack_handle_t *stack_p,
   ...
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_CONTEXT_REQ,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_GUTI, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_guti_ie_get, &req_p->old_guti);
  DevAssert(NW_OK == rc);

  /* RAT-Type. */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_RAT_TYPE, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_rat_type_ie_get, &req_p->rat_type);
  DevAssert(NW_OK == rc);
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_SERVING_NETWORK, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_serving_network_ie_get,
   ...
   */
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_COMPLETE_REQUEST_MESSAGE,
      NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL,
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                                 "CONTEXT_REQUEST local S10 teid " TEID_FMT " ",
                                 req_p->teid);
    /*
     * TODO: handle this case
  ...
  MSC_LOG_RX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "CONTEXT_REQUEST local S10 teid " TEID_FMT, req_p->teid);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_context_response(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  ulp_rsp.u_api_info.triggeredRspInfo.teidLocal =
      rsp_p->s10_source_mme_teid.teid;
  ...
  if (rsp_p->cause.cause_value == REQUEST_ACCEPTED) {
    ...
    OAILOG_WARNING(
        LOG_S10,
        "The cause is not REQUEST_ACCEPTED but %d for S10_CONTEXT_RESPONSE. "
        "Not creating a local S10 Tunnel @ triggered response! \n",
        rsp_p->cause);
  }

  rc =
      nwGtpv2cMsgNew(*stack_p, true, NW_GTP_CONTEXT_RSP, 0, 0, &(ulp_rsp.hMsg));
  DevAssert(NW_OK == rc);
  /*
   * Set the destination TEID
   */
  ...
  /** Add the S10 Cause : Not setting offending IE type now. */
  rc = nwGtpv2cMsgAddIeCause((ulp_rsp.hMsg), 0, rsp_p->cause.cause_value, 0, 0,
                             0);
  DevAssert(NW_OK == rc);
  ...
  if (rsp_p->cause.cause_value == REQUEST_ACCEPTED) {
    ...
    rc = nwGtpv2cMsgAddIeFteid(
        (ulp_rsp.hMsg), NW_GTPV2C_IE_INSTANCE_ZERO, S10_MME_GTP_C,
        rsp_p->s10_source_mme_teid.teid, /**< FTEID of the TARGET_MME. */
        rsp_p->s10_source_mme_teid.ipv4
            ? &rsp_p->s10_source_mme_teid.ipv4_address
            : 0,
        rsp_p->s10_source_mme_teid.ipv6
            ? &rsp_p->s10_source_mme_teid.ipv6_address
            : NULL);

    /** Add the S10 source-MME SAE-GW FTEID. */
    rc = nwGtpv2cMsgAddIeFteid(
        (ulp_rsp.hMsg), NW_GTPV2C_IE_INSTANCE_ONE, S11_SGW_GTP_C,
    ...
    DevAssert(MSG_FORWARD_RELOCATION_REQUEST_MAX_PDN_CONNECTIONS >=
              rsp_p->pdn_connections->num_pdn_connections);
    for (int num_pdn = 0; num_pdn < rsp_p->pdn_connections->num_pdn_connections;
         num_pdn++) {
      pdn_connection_t *pdn_connection =
          &rsp_p->pdn_connections->pdn_connection[num_pdn];
  ...
  if (rsp_p->cause.cause_value == REQUEST_ACCEPTED) {
    OAILOG_INFO(LOG_S10,
                "INSERTING INTO S10 HASHTABLE teid " TEID_FMT
                " and tunnel object %p. \n",
                ulp_rsp.u_api_info.triggeredRspInfo.teidLocal,
                ulp_rsp.u_api_info.triggeredRspInfo.hTunnel);
    hashtable_rc_t hash_rc = hashtable_ts_insert(
        s10_mme_teid_2_gtv2c_teid_handle, /**< Directly register the created
                                             tunnel. */
        (hash_key_t)ulp_rsp.u_api_info.triggeredRspInfo.teidLocal,
        (void *)ulp_rsp.u_api_info.triggeredRspInfo
            .hTunnel); /**< Just store the value as int (no free method) after
                          allocating the S10 GTPv2c Tunnel from the tunnel pool.
                        */
    hash_rc = hashtable_ts_get(
        s10_mme_teid_2_gtv2c_teid_handle,
        (hash_key_t)ulp_rsp.u_api_info.triggeredRspInfo.teidLocal,
        (void **)(uintptr_t)&ulp_rsp.u_api_info.triggeredRspInfo.hTunnel);
    DevAssert(hash_rc == HASH_TABLE_OK);
  } else {
    OAILOG_WARNING(
        LOG_S10,
...
int s10_mme_handle_context_response(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  memcpy((void *)&resp_p->mme_peer_ip,
         pUlpApi->u_api_info.triggeredRspIndInfo.peerIp,
         pUlpApi->u_api_info.triggeredRspIndInfo.peerIp->sa_family == AF_INET
             ? sizeof(struct sockaddr_in)
             : sizeof(struct sockaddr_in6));

  /** Create a new message parser.     */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_CONTEXT_RSP,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_IMSI, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, gtpv2c_imsi_ie_get, &resp_p->imsi);
  DevAssert(NW_OK == rc);
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_MM_EPS_CONTEXT, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s10_mm_ue_context_ie_get,
      resp_p->ue_eps_mm_context);
  DevAssert(NW_OK == rc);
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "CONTEXT_RESPONSE local S10 teid " TEID_FMT " ", resp_p->teid);
    /*
     * TODO: handle this case
     */
    itti_free(ITTI_MSG_ORIGIN_ID(message_p), message_p);
  ...
  MSC_LOG_RX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "0 CONTEXT_RESPONSE local S10 teid " TEID_FMT
                     " num pdn connections %u",
                     resp_p->teid, resp_p->pdn_connections.num_pdn_connections);
  int result = itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);

  if (resp_p->cause.cause_value != REQUEST_ACCEPTED) {
    OAILOG_ERROR(LOG_S10,
                 "Context request for local teid " TEID_FMT
                 " failed. Removing S10 tunnel endpoint on target side. \n",
                 resp_p->teid);
    ...
    memcpy((void *)&remove_s10_tunnel.mme_peer_ip, &resp_p->mme_peer_ip,
           (resp_p->mme_peer_ip.addr_v4.sin_family == AF_INET)
               ? sizeof(struct sockaddr_in)
               : sizeof(struct sockaddr_in6));
...
int s10_mme_context_acknowledge(nw_gtpv2c_stack_handle_t *stack_p,
   ...
   * Stage 2 procedures. Context Acknowledge is always triggered message and
   * does not have a reply. NOTE 2: The "Context Acknowledge" message is sent
   * only if the "Context Response" message is received with the acceptance
   * cause.
   */
  ulp_ack.apiType = NW_GTPV2C_ULP_API_TRIGGERED_ACK;
  ulp_ack.u_api_info.triggeredAckInfo.peerIp =
      (struct sockaddr *)&ack_p->mme_peer_ip;
  ...
  int hash_rc = hashtable_ts_get(
      s10_mme_teid_2_gtv2c_teid_handle, (hash_key_t)ack_p->local_teid,
      (void **)(uintptr_t)&ulp_ack.u_api_info.triggeredAckInfo.hTunnel);

  /*
   * Prepare a context ack to send to target MME.
   */
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_CONTEXT_ACK, ack_p->teid,
                      ack_p->trxnId, &(ulp_ack.hMsg));
  DevAssert(NW_OK == rc);

  /** Add the S10 Cause : Not setting offending IE type now. */
  rc = nwGtpv2cMsgAddIeCause((ulp_ack.hMsg), 0, ack_p->cause.cause_value, 0, 0,
                             0);
  DevAssert(NW_OK == rc);

  /**
   * No timer will be started, just the existing transaction will be further
   * used. The seq_no and peer details will be pulled from the transaction. The
   * S10 Tunnel will not be removed. Only with implicit detach.
   *
   * We will check, if there exists an initial request transaction for this
   * message.
   */
  rc = nwGtpv2cProcessUlpReq(*stack_p, &ulp_ack);
  DevAssert(NW_OK == rc);
  MSC_LOG_TX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "CONTEXT_ACKNOWLEDGE with cause %d ", ack_p->cause);
   ...
   */
  hash_rc = hashtable_ts_free(s10_mme_teid_2_gtv2c_teid_handle,
...
//------------------------------------------------------------------------------
// todo: evaluate later the error cause in the removal!! --> eventually if
// something goes wrong here.. check the reason!
int s10_mme_remove_ue_tunnel(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  MSC_LOG_RX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "Removing S10 UE Tunnels for local S10 teid " TEID_FMT " ",
  ...
  if (remove_ue_tunnel_p->local_teid == (teid_t)0) {
    OAILOG_ERROR(LOG_S10,
                 "Cannot remove S10 tunnel endpoint for local teid 0. \n");
  ...
  if (HASH_TABLE_OK != hash_rc) {
    ...
    //    pLocalTunnel = RB_FIND (NwGtpv2cTunnelMap, &(thiz->tunnelMap),
    //    &keyTunnel);

    OAILOG_ERROR(LOG_S10,
                 "Could not get GTPv2-C hTunnel for local teid " TEID_FMT
                 ". \n",
                 remove_ue_tunnel_p->local_teid);
    MSC_LOG_EVENT(MSC_S10_MME, "Failed to deleted local teid " TEID_FMT "",
                  remove_ue_tunnel_p->local_teid);
    ...
    ulp_req.u_api_info.findLocalTunnelInfo.teidLocal =
        remove_ue_tunnel_p->local_teid;
    ulp_req.u_api_info.findLocalTunnelInfo.edns_peer_ip =
        (struct sockaddr *)&remove_ue_tunnel_p->mme_peer_ip;
    rc = nwGtpv2cProcessUlpReq(*stack_p, &ulp_req);
    DevAssert(NW_OK == rc);
    if (ulp_req.u_api_info.findLocalTunnelInfo.hTunnel) {
      OAILOG_ERROR(LOG_S10,
                   "Could FIND A GTPv2-C hTunnel for local teid " TEID_FMT
                   " @ DELETION \n",
                   remove_ue_tunnel_p->local_teid);
    } else {
      OAILOG_ERROR(LOG_S10,
                   "Could NOT FIND A GTPv2-C hTunnel for local teid " TEID_FMT
                   " @ DELETION \n",
                   remove_ue_tunnel_p->local_teid);
    }
    ...
    DevAssert(NW_OK == rc);
    OAILOG_INFO(LOG_S10,
                "DELETED local S10 teid (TEID FOUND IN HASH_MAP)" TEID_FMT
                " \n",
                remove_ue_tunnel_p->local_teid);
    ...
    /**
     * hash_free_int_func is set as the freeing function.
     * The value is removed from the map. But the value itself (int) is not
     * freed. The Tunnels are not deallocated but just set back to the Tunnel
     * pool.
     */
    hash_rc = hashtable_ts_free(s10_mme_teid_2_gtv2c_teid_handle,
                                (hash_key_t)remove_ue_tunnel_p->local_teid);
    ...
    OAILOG_DEBUG(LOG_S10,
                 "Successfully removed S10 Tunnel local teid " TEID_FMT ".\n",
                 remove_ue_tunnel_p->local_teid);
...
int s10_mme_handle_context_acknowledgement(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 CONTEXT_ACKNOWLEDGE local S10 teid " TEID_FMT " ", ack_p->teid);
    /*
     * TODO: handle this case
     */
    itti_free(ITTI_MSG_ORIGIN_ID(message_p), message_p);
  ...
  MSC_LOG_RX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "0 CONTEXT_ACKNOWLEDGE local S10 teid " TEID_FMT
                     " with cause %d ",
                     ack_p->teid, ack_p->cause);
  return itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
}
...
int s10_mme_relocation_cancel_request(
  ...
  /** Setting the local teid twice, once here once later. */
  ulp_req.u_api_info.initialReqInfo.teidLocal =
      req_p->local_teid; /**< Used to get the local tunnel... */
  ...
  /** Setting the destination TEID from MME_APP. */
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_RELOCATION_CANCEL_REQ, req_p->teid,
                      0, &(ulp_req.hMsg));
  ulp_req.u_api_info.initialReqInfo.edns_peer_ip =
      (struct sockaddr *)&req_p->mme_peer_ip;
  ...
  MSC_LOG_TX_MESSAGE(MSC_S10_MME, MSC_SGW, NULL, 0,
                     "0 RELOCATION_CANCEL_REQUEST local S10 teid " TEID_FMT,
                     req_p->local_teid);
  ...
  hash_rc = hashtable_ts_get(
      s10_mme_teid_2_gtv2c_teid_handle, (hash_key_t)req_p->local_teid,
      (void **)(uintptr_t)&ulp_req.u_api_info.deleteLocalTunnelInfo.hTunnel);
  ...
  //  DevAssert (NW_OK == rc);
  //  if(ulp_req.u_api_info.findLocalTunnelInfo.hTunnel){
  //    OAILOG_WARNING (LOG_S10, "Could FIND A GTPv2-C hTunnel for local teid %X
  //    @ DELETION (2) \n", req_p->local_teid);
  //  }else{
  //    OAILOG_WARNING(LOG_S10, "Could NOT FIND A GTPv2-C hTunnel for local teid
  //    %X @ DELETION  (2) \n", req_p->local_teid);
  //  }
...
int s10_mme_handle_relocation_cancel_request(nw_gtpv2c_stack_handle_t *stack_p,
   ...
   * Create a new message parser
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_RELOCATION_CANCEL_REQ,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  /*
   * IMSI IE
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_IMSI, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_MANDATORY, gtpv2c_imsi_ie_get, &req_p->imsi);
  DevAssert(NW_OK == rc);
...
int s10_mme_relocation_cancel_response(
  ...
  ulp_rsp.apiType = NW_GTPV2C_ULP_API_TRIGGERED_RSP;
  ulp_rsp.u_api_info.triggeredRspInfo.hTrxn = trxn;
  rc = nwGtpv2cMsgNew(*stack_p, true, NW_GTP_RELOCATION_CANCEL_RSP, 0, 0,
                      &(ulp_rsp.hMsg));
  DevAssert(NW_OK == rc);
  /*
   * Set the destination TEID
  ...
  /** Add the S10 Cause : Not setting offending IE type now. */
  rc = nwGtpv2cMsgAddIeCause(
      (ulp_rsp.hMsg), 0, relocation_cancel_resp_p->cause.cause_value, 0, 0, 0);
  DevAssert(NW_OK == rc);
  ...
  /*
   * If a handover procedure exists, the tunnel enpoint will be removed with
   * that procedure. Not with this message.
   */
  ...
  //
  //  hashtable_rc_t hash_rc =
  //  hashtable_ts_get(s10_mme_teid_2_gtv2c_teid_handle,
  //      (hash_key_t) relocation_cancel_resp_p->local_teid, (void
  //      **)(uintptr_t)&ulp_rsp.u_api_info.deleteLocalTunnelInfo.hTunnel);
  //  if (HASH_TABLE_OK != hash_rc) {
  //    OAILOG_WARNING (LOG_S10, "Could not get GTPv2-C hTunnel for local TEID
  //    %X on S10 MME interface. \n", relocation_cancel_resp_p->local_teid);
  //    return RETURNok;
  //  }
  //
  //  rc = nwGtpv2cProcessUlpReq (*stack_p, &ulp_rsp);
  //  DevAssert (NW_OK == rc);
  //  OAILOG_INFO(LOG_S10, "DELETED local S10 teid (TEID FOUND IN HASH_MAP)"
  //  TEID_FMT " \n", relocation_cancel_resp_p->local_teid);
   ...
   * The Tunnels are not deallocated but just set back to the Tunnel pool.
   */
  //  hash_rc = hashtable_ts_free(s10_mme_teid_2_gtv2c_teid_handle, (hash_key_t)
  //  relocation_cancel_resp_p->local_teid); DevAssert (HASH_TABLE_OK ==
  //  hash_rc);
  return RETURNok;
}
...
int s10_mme_handle_relocation_cancel_response(nw_gtpv2c_stack_handle_t *stack_p,
   ...
   * Create a new message parser
   */
  rc = nwGtpv2cMsgParserNew(*stack_p, NW_GTP_RELOCATION_CANCEL_RSP,
                            s10_ie_indication_generic, NULL, &pMsgParser);
  DevAssert(NW_OK == rc);
  /*
   * Cause IE
  ...
  rc = nwGtpv2cMsgParserAddIe(
      pMsgParser, NW_GTPV2C_IE_CAUSE, NW_GTPV2C_IE_INSTANCE_ZERO,
      NW_GTPV2C_IE_PRESENCE_MANDATORY, gtpv2c_cause_ie_get, &rsp_p->cause);
  DevAssert(NW_OK == rc);
  ...
  if (rc != NW_OK) {
    MSC_LOG_RX_DISCARDED_MESSAGE(
        MSC_S10_MME, MSC_SGW, NULL, 0,
        "0 RELOCATION_CANCEL_RESPONSE local S10 teid " TEID_FMT " ",
        rsp_p->teid);
    /*
     * TODO: handle this case
     */
...
int s10_mme_handle_ulp_error_indicatior(nw_gtpv2c_stack_handle_t *stack_p,
  ...
  switch (msgType) {
    ...
    case NW_GTP_FORWARD_RELOCATION_REQ: {
      ...
      message_p =
          itti_alloc_new_message(TASK_S10, S10_FORWARD_RELOCATION_RESPONSE);
      resp_p = &message_p->ittiMsg.s10_forward_relocation_response;
      memset(resp_p, 0, sizeof(*resp_p));
      /** Set the destination TEID (our TEID). */
      resp_p->teid = pUlpApi->u_api_info.rspFailureInfo.teidLocal;
    ...
    case NW_GTP_FORWARD_ACCESS_CONTEXT_NTF: {
      ...
      message_p = itti_alloc_new_message(
          TASK_S10, S10_FORWARD_ACCESS_CONTEXT_ACKNOWLEDGE);
      ack_p = &message_p->ittiMsg.s10_forward_access_context_acknowledge;
      memset(ack_p, 0, sizeof(*ack_p));
      /** Set the destination TEID (our TEID). */
      ack_p->teid = pUlpApi->u_api_info.rspFailureInfo.teidLocal;
    ...
    case NW_GTP_FORWARD_RELOCATION_COMPLETE_NTF: {
      itti_s10_forward_access_context_acknowledge_t *ack_p;
      /** Respond with an S10 Forward Relocation Complete Acknowledgment
       * Failure. */
      message_p = itti_alloc_new_message(
          TASK_S10, S10_FORWARD_RELOCATION_COMPLETE_ACKNOWLEDGE);
      ack_p = &message_p->ittiMsg.s10_forward_relocation_complete_acknowledge;
    ...
    case NW_GTP_RELOCATION_CANCEL_REQ: {
      ...
      //     OAILOG_WARNING (LOG_S10, "Not handling timeout for relocation
      //     cancel request for local S10-TEID " TEID_FMT ". \n",
      //     pUlpApi->u_api_info.rspFailureInfo.teidLocal);
      itti_s10_relocation_cancel_response_t *resp_p;
      message_p =
          itti_alloc_new_message(TASK_S10, S10_RELOCATION_CANCEL_RESPONSE);
  ...
  OAILOG_WARNING(LOG_S10,
                 "Received an error indicator for the local S10-TEID " TEID_FMT
                 " and message type %d. \n",
                 pUlpApi->u_api_info.rspFailureInfo.teidLocal,
